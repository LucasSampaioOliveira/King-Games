...
class Player extends Mover {
    ...
    update(dt) {
        ...
        if((this.pos.x + this.p2[0] - finish[0])*(this.pos.x + this.p1[0] - finish[0]) < 0 && (this.pos.y + this.p2[1] - finish[1])*(this.pos.y + this.p1[1] - finish[1]) < 0) {
                ...
                document.getElementById("title").innerHTML = "Você escapou";
                ...
                document.getElementById("title").innerHTML = "Você morreu";
...
function main() {
    ...
    document.getElementById("loader-text").innerHTML = "Click na tela para jogar";
